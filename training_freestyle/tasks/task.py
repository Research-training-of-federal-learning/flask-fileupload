...
from training_GTSRB.metrics.accuracy_metric import AccuracyMetric
from training_GTSRB.metrics.metric import Metric
from training_GTSRB.metrics.test_loss_metric import TestLossMetric
from training_GTSRB.tasks.batch import Batch
...
class Task:
    ...
    def __init__(self, params: Params,train_dataset,test_dataset,model):
        self.params = params
        self.init_task(train_dataset,test_dataset,model)

    def init_task(self,train_dataset,test_dataset,model):
        self.load_data()
        self.model = model
        self.resume_model()
