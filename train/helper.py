...
from train.attack import Attack
from train.tasks.fl.fl_task import FederatedLearningTask
from train.utils.parameters import Params
from train.utils.utils import create_logger, create_table
...
class Helper:
    ...
    def make_task(self):
        ...
        if self.params.fl:
            module_name = f'train.tasks.fl.{name_lower}_task'
            path = f'train/tasks/fl/{name_lower}_task.py'
        else:
            module_name = f'train.tasks.{name_lower}_task'
            path = f'train/tasks/{name_lower}_task.py'
        try:
    ...
    def make_folders(self):
        ...
        if self.params.log:
            ...
            with open('train/saved_models/runs.html', 'a') as f:
