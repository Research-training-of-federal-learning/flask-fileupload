...
from training.attack import Attack
from training.tasks.fl.fl_task import FederatedLearningTask
from training.utils.parameters import Params
from training.utils.utils import create_logger, create_table
...
class Helper:
    ...
    def make_task(self):
        ...
        if self.params.fl:
            module_name = f'training.tasks.fl.{name_lower}_task'
            path = f'training/tasks/fl/{name_lower}_task.py'
        else:
            module_name = f'training.tasks.{name_lower}_task'
            path = f'training/tasks/{name_lower}_task.py'
        try:
    ...
    def make_folders(self):
        ...
        if self.params.log:
            ...
            with open('training/saved_models/runs.html', 'a') as f:
    ...
    def report_training_losses_scales(self, batch_id, epoch):
        ...
        # print(1111111111)
        # print(self.params.running_losses.items())
        # die()
