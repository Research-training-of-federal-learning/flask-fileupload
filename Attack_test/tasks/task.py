...
from Attack.metrics.accuracy_metric import AccuracyMetric
from Attack.metrics.metric import Metric
from Attack.metrics.test_loss_metric import TestLossMetric
from Attack.tasks.batch import Batch
...
class Task:
    ...
    def resume_model(self):
        if self.params.resume_model:
            ...
            loaded_params = torch.load(f"Attack/saved_models/"
