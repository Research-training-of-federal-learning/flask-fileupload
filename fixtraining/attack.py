...
from fixtraining.models.model import Model
from fixtraining.models.nc_model import NCModel
from fixtraining.synthesizers.synthesizer import Synthesizer
from fixtraining.losses.loss_functions import compute_all_losses_and_grads
from fixtraining.utils.min_norm_solvers import MGDASolver
...
class Attack:
    ...
    def __init__(self, params, synthesizer, synthesizer2):
        self.params = params
    ...
    def compute_blind_loss(self, model, criterion, batch, attack):
        ...
        if len(loss_tasks) == 1:
            ...
            loss_values, grads = compute_all_losses_and_grads(
                loss_tasks,
                self, model, criterion, batch, batch_back, batch_back2, compute_grad=True)
            if len(loss_tasks) > 1:
