...
from fixtraining.attack import Attack
from fixtraining.synthesizers.synthesizer import Synthesizer
from fixtraining.tasks.fl.fl_task import FederatedLearningTask
from fixtraining.tasks.task import Task
from fixtraining.utils.parameters import Params
from fixtraining.utils.utils import create_logger, create_table
...
class Helper:
    ...
    def __init__(self, params):
        ...
        self.attack = Attack(self.params, self.synthesizer, self.synthesizer2)
    ...
    def make_task(self):
        ...
        if self.params.fl:
            module_name = f'fixtraining.tasks.fl.{name_lower}_task'
            path = f'fixtraining/tasks/fl/{name_lower}_task.py'
        else:
            module_name = f'fixtraining.tasks.{name_lower}_task'
            path = f'fixtraining/tasks/{name_lower}_task.py'
        try:
    ...
    def make_synthesizer(self):
        ...
        module_name = f'fixtraining.synthesizers.{name_lower}_synthesizer'
        try:
    ...
    def make_folders(self):
        ...
        if self.params.log:
            ...
            with open('fixtraining/saved_models/runs.html', 'a') as f:
