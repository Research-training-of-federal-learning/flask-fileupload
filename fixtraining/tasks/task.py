...
from fixtraining.metrics.accuracy_metric import AccuracyMetric
from fixtraining.metrics.metric import Metric
from fixtraining.metrics.test_loss_metric import TestLossMetric
from fixtraining.tasks.batch import Batch
...
class Task:
    ...
    def resume_model(self):
        if self.params.resume_model:
            ...
            loaded_params = torch.load(f"fixtraining/saved_models/"
