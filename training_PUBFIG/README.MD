...
python training.py --name gtsrb --params configs/gtsrb_params.yaml --commit none
python training.py --name pubfig --params configs/pubfig_params.yaml --commit none
```
